...
{cartItem.length} products are selected 
      </span> <button onClick={handleOrder} className=" px-2 rounded-lg h-8  w-36 bg-orange-500 bg-opacity-70 text-white  font-thin hover:text-white hover:text-opacity-50 hover:bg-opacity-50">oreder now </button></div>
    </>
  )}
  {cartItem.length > 0 ? (
