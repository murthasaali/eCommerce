    ...
    <motion.div
        ...
        >
          ...
          >
            ...
            <div className='h-56 w-72 flex bg-stonee-200  flex-col rounded-lg justify-center gap-2 items-start overflow-hidden'
            >
             <motion.div
             initial={{scale:1}}
            ...
            >
                   ...
                   <p className='font-thin text-orange-600 text-opacity-60 flex justify-center items-start gap-5'><span className='text-2xl flex items-center justify-around '></span >  {value.title}  <FaHeart className='text-xl text-white text-opacity-60'  />
                   </p></div>
            ))}
            </div>
          </motion.div>
